...
if rad == "ABOUT ME":
    ...
    3. Sit back and Relax! while the Web App makes Data Analysis Report for you!
    ...
    ![image](https://raw.githubusercontent.com/Gouthique/Data/main/Streamlit/Pictures/DA_app-files/Overview.1.png)
    
    2. Warnings Section:
    You can Find The important factors of variables here!
    ![image](https://raw.githubusercontent.com/Gouthique/Data/main/Streamlit/Pictures/DA_app-files/Overview.2.png)
    ...
    ![image](https://raw.githubusercontent.com/Gouthique/Data/main/Streamlit/Pictures/DA_app-files/Overview.3.png)
    ...
    ![image](https://raw.githubusercontent.com/Gouthique/Data/main/Streamlit/Pictures/DA_app-files/Variables.1.png)
    ...
    ![image](https://raw.githubusercontent.com/Gouthique/Data/main/Streamlit/Pictures/DA_app-files/COR.1.png)
    ...
    ![image](https://raw.githubusercontent.com/Gouthique/Data/main/Streamlit/Pictures/DA_app-files/Missing_values.1.png)
    ...
    ![image](https://raw.githubusercontent.com/Gouthique/Data/main/Streamlit/Pictures/DA_app-files/Data_limit_1.png)
...
if rad == "USE APP":
    with st.sidebar.header('1. Upload your CSV data'):
        ...
        st.sidebar.markdown("""
    [Example CSV input file](https://raw.githubusercontent.com/Gouthique/Data/main/Streamlit/Pictures/DA_app-files/Test_data_sets/delaney_solubility_with_descriptors.csv)
    """)
